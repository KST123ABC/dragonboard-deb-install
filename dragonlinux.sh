...
curl -LOkz dragonboard410c_sdcard_developer_debian-260.zip  http://builds.96boards.org/releases/dragonboard410c/linaro/debian/latest/dragonboard410c_sdcard_developer_debian-260.zip
